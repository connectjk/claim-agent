...
def deploy():
    ...
    payload = json.dumps({
        "name": sanitize_name("claim_agent"),
        "description": """A Claim Policy agent that can search our knowledge base, Provide a Claim related information""",
        "definition": {
            "kind": "prompt",
            "model": "gpt-4o",
            "instructions": """A Claim Policy agent that can search our knowledge base, Provide a Claim related information"""
        }
    }).encode()
